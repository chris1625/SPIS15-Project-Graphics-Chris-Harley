   ...
   # for c in range (width - 2):
    ...
    for u in range (widthchange+1):
        ...
        while endY != 0:
            ...
            if endLocation - pathwaytable[endLocation][endY][0] > 1 or endLocation - pathwaytable[endLocation][endY][0] < -1: 
                print endLocation - pathwaytable[endLocation][endY][0]
